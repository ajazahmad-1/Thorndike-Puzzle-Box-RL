...
Only one action produces a reward.

The agent selects actions randomly over multiple trials.
...
3.A function evaluates the selected action.

4.The simulation runs for a fixed number of trials.

5.Each trial prints the chosen action and the reward received.
